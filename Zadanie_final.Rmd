...
-   **H0** : Neexistuje statistiky významný vplyv počtu gólov a asistencií na pravdepodobnosť byť klasifikovaný ako ofenzívny hráč.
-   **H1**: Existuje statistiky významný vplyv počtu gólov a asistencií na pravdepodobnosť byť klasifikovaný ako ofenzívny hráč.
-   **H2**: Existuje statistiky významný vplyv počtu trestných minút na pravdepodobnosť byť klasifikovaný ako defenzívny hráč.
-   **H3**: Existuje statistiky významný vplyv plus/minus hodnotenia na pravdepodobnosť byť klasifikovaný ako ofenzívny hráč.
